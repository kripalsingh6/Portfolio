...
export default function Hero() {
  return (
    <section className='relative w-full min-h-[100dvh] sm:h-screen sm:min-h-screen mx-auto flex flex-col overflow-x-clip'>
      {/* ── Text content ── */}
      <div className="w-full max-w-7xl mx-auto px-7 xs:px-8 sm:px-16 mt-[120px] xs:mt-[130px] sm:mt-0 sm:absolute sm:inset-0 sm:top-[125px] flex flex-row items-start gap-3 sm:gap-5 z-10 sm:pointer-events-none">
        {/* Purple dot + gradient line — hidden on mobile to save space */}
        ...
        <div className='sm:pointer-events-auto flex-1 min-w-0'>
          {/* Mobile-only accent bar */}
          <div className="sm:hidden w-10 h-1 rounded-full bg-gradient-to-r from-[#915eff] to-[#00cea8] mb-4" />

          <h1 className='font-black text-white text-[36px] xs:text-[42px] sm:text-[56px] lg:text-[72px] leading-[1.1] sm:leading-[88px]'>
            Hi, I'm <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#915eff] via-[#b87dff] to-[#00cea8]'>Kripal</span>
          </h1>
          <p className='text-[14.5px] sm:text-[17px] text-[#aaa6c3] font-medium tracking-wide mt-4 sm:mt-3 max-w-2xl leading-[23px] sm:leading-[28px]'>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-6 sm:mt-6">
            <a
              href="#projects"
      ...
      {/* ── Scroll indicator ── */}
      <div className='w-full flex justify-center items-center z-10 pointer-events-auto py-12 sm:py-0 sm:absolute sm:bottom-8 mt-auto'>
